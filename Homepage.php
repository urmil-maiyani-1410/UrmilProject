        ...
        if(isset($_GET['btnSearch']))
        {
            ...
            if($result)
            {
                 ...
                 if ($row_count == 0)
                    ...
                    echo "<table border='2' align='center' cellspacing='9' cellpadding='10'>";
            echo "<tr>
                    <th> Name </th>
                    <th> Area </th>
                    <th> profession </th>
                ...
                while($row = mysqli_fetch_array($result))
                {
                        ...
                        <td> " . $row[11] . " </td>
                        <td> " . $row[12] . " </td>
                        <td><a href='Booking.php?id=".$row[0]."'><button  class='form-control btn btn-success' name='btnBook' type='button'>Book</button></a></td>
                        </tr>";     
